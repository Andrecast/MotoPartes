...
public class ProviderMovement implements Serializable {
    ...
    //@DateTimeFormat(pattern = "yyyy-MM-dd") con prePersist lo va hacer automático
    ...
    //@Column(nullable = false)
    private String status; //Es 1 si el movimiento es una compra y 0 si es una devolución
